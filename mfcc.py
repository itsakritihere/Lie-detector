...
# === CONFIGURATION ===
AUDIO_PATH = "cleaning/cleaned_data/truth/t17.wav"  # ← Update with your file path
SAMPLE_RATE = 16000
N_MFCC = 13
NFFT = 512
...
df.to_excel("ft17.xlsx", index=False)
print("Feature extraction completed. Saved as 'ft17.xlsx'.")